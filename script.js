...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Funkcja generująca losowe dane kontaktowe
    function generateRandomContact() {
        const phones = [
            "+48 600 234 555", "+48 502 992 110", "+48 789 229 331",
            "+48 513 882 552", "+48 690 551 100"
        ];

        const streets = [
            "ul. Lipowa 12", "ul. Miodowa 44", "ul. Kwiatowa 8",
            "ul. Słoneczna 19", "ul. Jesionowa 2"
        ];
        ...
        const emails = [
            "kontakt@coinbuy.pl", "support@coinbuy.pl",
            "biuro@coinbuy.pl", "helpdesk@coinbuy.pl"
        ];
